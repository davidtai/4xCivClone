...
start cmd /K "uglifyjs release\public\gamemerged.js > release\public\game.js && rm -f release\public\gamemerged.js && exit"

start cmd /K "uglifyjs main.js > release\public\main.js && exit"
