...
(function() {
  var Engine, MT, global, scale, seed, size, split, tileSize, worldSize,
  ...
  this.Engine = Engine = (function(superClass) {
    ...
    Engine.prototype.init = function() {
      ...
      offset.setPosition(new cc.Point(0, config.disabledSmoothing ? config.screen.height * config.screen.scale : void 0));
    ...
    Engine.prototype.update = function(dt) {
      var child, children, i, len, move, position, ref;
      if (this.ready) {
